...
import { handleEpochUpdateRewards, handleEpochUnstakeSuccess, handleEpochCleanup } from './epoch-action';
import {
...
function handleEvent(
  ...
  } else if (event == 'epoch_cleanup') {
    handleEpochCleanup(data, receipt);
  }
}
